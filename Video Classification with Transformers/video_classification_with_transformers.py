...
Original file is located at
    https://colab.research.google.com/drive/1t54RsJiuQPgJ7igxvI5xG9JGK7SAdAPP
...
this example, I used a subsampled version of the
...
* I reduced the image size to 128x128 instead of 224x224 to speed up computation.
...
* I directly pad shorter videos to length `MAX_SEQ_LENGTH`.
...
def prepare_all_videos(df, root_dir):
    ...
    # `frame_features` are what fed to the sequence model.
